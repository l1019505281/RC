...
void moving_init(void)  //***********************************************************************待调
{
	...
	PID_parameter_init(&yaw_pid, 10, 0.04, 2, 0, 0);
...
void moving_path_tracking(void)
{
	...
	{
		case 0 : moving_yaw_adjusting_pure_PID();
		case 1 : moving_yaw_adjusting_time_and_PID();
		default : break;
	}
}
...
{
//		if(ROBOT_REAL_POS_DATA.Y_POS > 5750) return 1;
	if(ROBOT_REAL_POS_DATA.X_POS > -1400) return 1;
	else return 0;
}
...
{
	if(ROBOT_REAL_POS_DATA.Y_POS < 8700) return 1;
	else return 0;
}
//交接
//////////////////////////////////////////////////
...
{
	if(ROBOT_REAL_POS_DATA.X_POS > -3475) return 1;
	else return 0;
}
//拾取兽骨
//////////////////////////////////////////////////
