...
//	// 运动学方程（之前的）
//	GL_POS_DATA.X += SIN45 * cos(GL_POS_DATA.YAW / 180.0f * PI) * (ENCO_DIS_DATA.DELTA_DIS_Y - ENCO_DIS_DATA.DELTA_DIS_X) -
//									 SIN45 * sin(GL_POS_DATA.YAW / 180.0f * PI) * (ENCO_DIS_DATA.DELTA_DIS_Y + ENCO_DIS_DATA.DELTA_DIS_X);
//	GL_POS_DATA.Y += -(SIN45 * sin(GL_POS_DATA.YAW / 180.0f * PI) * (ENCO_DIS_DATA.DELTA_DIS_Y - ENCO_DIS_DATA.DELTA_DIS_X) +
//									 SIN45 * cos(GL_POS_DATA.YAW / 180.0f * PI) * (ENCO_DIS_DATA.DELTA_DIS_Y + ENCO_DIS_DATA.DELTA_DIS_X));
...
//	GL_POS_DATA.X += (ENCO_DIS_DATA.DELTA_DIS_X - Lx * delta_rad) * sin((GL_POS_DATA.YAW + YAW0) / 180.0f * PI) + 
//	                 (ENCO_DIS_DATA.DELTA_DIS_Y + Ly * delta_rad) * cos((GL_POS_DATA.YAW + YAW0) / 180.0f * PI);
//	
//	GL_POS_DATA.Y += (ENCO_DIS_DATA.DELTA_DIS_X - Lx * delta_rad) * cos((GL_POS_DATA.YAW + YAW0) / 180.0f * PI) - 
//									 (ENCO_DIS_DATA.DELTA_DIS_Y + Ly * delta_rad) * sin((GL_POS_DATA.YAW + YAW0) / 180.0f * PI);
//									 
//	GL_POS_DATA.X += ENCO_DIS_DATA.DELTA_DIS_X * sin((GL_POS_DATA.YAW + YAW0) / 180.0f * PI) +
//									 ENCO_DIS_DATA.DELTA_DIS_Y * cos((GL_POS_DATA.YAW + YAW0) / 180.0f * PI) -
//									 Lx * delta_rad * sin((GL_POS_DATA.YAW + YAW0) / 180.0f * PI) -
//									 Ly * delta_rad * cos((GL_POS_DATA.YAW + YAW0) / 180.0f * PI);								 
//	
//	GL_POS_DATA.Y += ENCO_DIS_DATA.DELTA_DIS_X * sin((GL_POS_DATA.YAW + YAW0) / 180.0f * PI) -
//									 ENCO_DIS_DATA.DELTA_DIS_Y * cos((GL_POS_DATA.YAW + YAW0) / 180.0f * PI) +
//									 Lx * delta_rad * cos((GL_POS_DATA.YAW + YAW0) / 180.0f * PI) -
//									 Ly * delta_rad * cos((GL_POS_DATA.YAW + YAW0) / 180.0f * PI);
//	
