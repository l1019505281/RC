...
void pick_bone_PICK_BONE_Init()
{
		...
		//初始化所有限位开关的GPIO
		GPIO_InitStructure.GPIO_Pin = GPIO_Pin_1|GPIO_Pin_4|GPIO_Pin_5|GPIO_Pin_6|GPIO_Pin_7|GPIO_Pin_0; //PD上的限位开关
...
void pick_bone_LIMIT_SWITCH_UPDATE()
{
	...
	LIMIT_SWITCH.SWITCH_LEFT = GPIO_ReadInputDataBit(GPIOD,GPIO_Pin_0);
